...
using CSharpMetal.Problems.DTLZ;
...
namespace CSharpMetal.Metaheuristics.NsgaIII
{
    ...
    */
            ...
            indicators = new QualityIndicator(problem, @"../../DTLZ1(8)-PF.txt");

            algorithm = new ThetaNsgaiii(problem);
            //algorithm = new ssNSGAII(problem);

            // Algorithm parameters
            algorithm.InputParameters["populationSize"] = 900;
            algorithm.InputParameters["maxEvaluations"] = 25000;
            algorithm.InputParameters["theta"] = 5;
            algorithm.InputParameters["H"] = 5;
